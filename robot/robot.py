...
class Robot(Bot):
    ...
    def start(self):
        ...
        try:
            ...
            self.start_date = f"1/{prev_month.month}/{prev_month.year}" #self.parameters.get('date-from')
            self.end_date = f"{last_day_of_month(prev_month.year, prev_month.month)}/{prev_month.month}/{prev_month.year}" #self.parameters.get('date-to')
